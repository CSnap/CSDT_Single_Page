...
Cloud.prototype.saveToCloud = function (projectObject, callback) {
  ...
  switch (myself.applicationID) {
    ...
    case 90:
       ...
       *  */
      let rhythmData = {};
      rhythmData.string = projectObject.project;
...
// modified from stackoverflow - used to load files (Most useful for rhythm wheels)
